...
export default function ClientIsolationTable () {
  ...
  const rowActions: TableProps<ClientIsolationViewModel>['rowActions'] = [
    {
      key: getPolicyAllowedOperation(PolicyType.CLIENT_ISOLATION, PolicyOperation.DELETE),
      ...
      <PageHeader
        ...
        extra={filterByAccessForServicePolicyMutation([
          <TenantLink
            ...
            key={getPolicyAllowedOperation(PolicyType.CLIENT_ISOLATION, PolicyOperation.CREATE)}
