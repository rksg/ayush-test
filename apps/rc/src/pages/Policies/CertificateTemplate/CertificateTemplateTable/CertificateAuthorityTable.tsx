...
import { Loader, TableProps, Table, Button, showActionModal, SimpleListTooltip }                                                                                                                                        from '@acx-ui/components'
import { DetailDrawer, MAX_CERTIFICATE_PER_TENANT, deleteDescription }                                                                                                                                                  from '@acx-ui/rc/components'
import { useDeleteCertificateAuthorityMutation, useGetCertificateAuthoritiesQuery, useGetCertificateTemplatesQuery }                                                                                                    from '@acx-ui/rc/services'
import { CertificateAuthority, CertificateCategoryType, CertificateUrls, EXPIRATION_DATE_FORMAT, PolicyOperation, PolicyType, filterByAccessForServicePolicyMutation, getScopeKeyByPolicy, showAppliedInstanceMessage } from '@acx-ui/rc/utils'
