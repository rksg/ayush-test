...
import { isFirmwareVersionAbove10010h }                                            from '@acx-ui/rc/switch/utils'
...
const StaticRoutes = (props: { readOnly: boolean, switchDetail?: SwitchViewModel }) => {
  ...
  const toolBarRender = () => [
    isSupport8100 && switchDetail?.model?.startsWith('ICX8100') &&
      !isSupport8100StaticRouteMaxVe && !isFirmwareVersionAbove10010h(switchDetail?.firmwareVersion)
      ? []
