...
describe('Switch List Table', () => {
  ...
  it('should render page correctly', async () => {
    ...
    expect(await screen.findByText('FEK3224R013')).toBeVisible()
    expect(await screen.findByText('FMF3249Q0J2')).toBeVisible()
    expect(await screen.findByText(
      'MLISA Switch_111@video_test_12345_check_test_upd')).toBeVisible()
  })
