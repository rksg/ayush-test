...
export function SwitchRequirementsModal (props: {
  ...
  const switchImgUrl = 'https://support.ruckuswireless.com/software_terms_and_conditions/3794-ruckus-icx-fastiron-09-0-10h_cd2-ga-software-release-zip'
        ...
        <UI.OrderList>
          ...
          <UI.OrderList type={'a'}>
            <UI.ListItems>
              ...
              <UI.CommandRectengle>
                copy tftp flash &lt;TFTP server IP address&gt; SPR09010h_cd2ufi.bin primary
              </UI.CommandRectengle>
            </UI.ListItems>
            <UI.ListItems>
          ...
          <UI.ListItems>
            ...
            <UI.CommandRectengle style={{ marginLeft: '20px' }}>
              ...
              UNIT 1: compiled on Oct  3 2023 at 05:06:51 labeled as SPR09010h_cd2  <br />
