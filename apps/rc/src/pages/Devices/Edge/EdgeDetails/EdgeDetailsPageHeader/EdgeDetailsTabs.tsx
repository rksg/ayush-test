...
import { EdgeDeviceStatusEnum, EdgeViewModel }   from '@acx-ui/rc/utils'
import { useNavigate, useParams, useTenantLink } from '@acx-ui/react-router-dom'

const EdgeDetailsTabs = (props:{ currentEdge: EdgeViewModel }) => {
  const { $t } = useIntl()
  const params = useParams()
  const basePath = useTenantLink(`/devices/edge/${params.serialNumber}/edge-details/overview`)
  ...
  const currentEdgeOperational = (currentEdge?.deviceStatus === EdgeDeviceStatusEnum.OPERATIONAL)
