import { AFCPowerMode, AFCStatus, ApRadioBands, ApVenueStatusEnum, ApViewModel, EthernetPortType, IsolatePacketsTypeEnum, PoeOutModeEnum } from '@acx-ui/rc/utils'
...
export const triBandApCap = {
  apModels: [
    ...
    { model: 'T670',
      ...
      lanPortPictureDownloadUrl:
        'https://fakeLanPortPic/wifi/firmware/7.0.0.200.6181/t670.jpg',
      pictureDownloadUrl:
        'https://fakeApPic/wifi/firmware/7.0.0.200.6181/t670.jpg',
      canSupportCellular: false,
      simCardPrimaryEnabled: true,
      simCardPrimaryRoaming: true,
      simCardSecondaryEnabled: true,
...
export const apT670DeviceRadio = {
  apRadioParams24G: {
    method: 'CHANNELFLY',
    manualChannel: 0,
    useVenueSettings: true,
