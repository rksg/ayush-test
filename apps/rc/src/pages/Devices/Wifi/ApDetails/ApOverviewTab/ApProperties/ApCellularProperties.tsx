...
import { ApDetails } from '@acx-ui/rc/utils'
...
export const ApCellularProperties = (props: ApCellularPropertiesProps) => {
  ...
  const getSimPresent = () => {
    ...
    if (currentCellularInfo.cellularIsSIM0Present && currentCellularInfo.cellularIsSIM0Present === 'YES'){
    ...
    if (currentCellularInfo.cellularIsSIM1Present && currentCellularInfo.cellularIsSIM1Present === 'YES') {
    ...
    <>
      <Form.Item
        ...
        }
       {
          ...
          <SimPresent title={$t({ defaultMessage: 'SIM 1' })} style={{marginTop: '15px'}} 
