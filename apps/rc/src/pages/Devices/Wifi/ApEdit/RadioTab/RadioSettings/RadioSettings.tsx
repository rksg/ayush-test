...
export function RadioSettings () {
  ...
  }, [apData, apCapabilities, getApAvailableChannels, isApDataLoaded, setReadyToScroll, isWifiSwitchableRfEnabled, wifi7_320Mhz_FeatureFlag, enableAP70, venueId, tenantId, AFC_Featureflag, apViewContextData.apStatusData?.afcInfo, getVenueApModelBandModeSettings])
