...
export const messageMappings = {
  ...
  setting_cluster_tooltip: defineMessage({ defaultMessage: 'Select the cluster that all traffic will be tunneled to in the selected venue. Make sure SmartEdges have already set the core port' }),
