  ...
  useEffect(() => {
    const fetchLogo = async () => {
      loadResidentPortalLogo(params)
        ...
        .catch((reason) => { setLogoImageString(''), setMaxLogoSize(100) })
      ...
      loadResidentPortalFavIcon(params)
        ...
        .catch((reason) => { setFavIconImageString('') })
    }
                  ...
                  <Image 
                    ...
                    alt={residentPortalData?.uiConfiguration?.files?.favIconFileName ? 
                      $t({defaultMessage: 'Favicon: {imageName}'}, 
                        {imageName: residentPortalData?.uiConfiguration?.files?.favIconFileName}) 
