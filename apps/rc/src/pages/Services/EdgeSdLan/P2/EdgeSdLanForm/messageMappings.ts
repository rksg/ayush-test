...
export const messageMappings = {
  ...
  setting_cluster_helper: defineMessage({ defaultMessage: 'To use the SD-LAN service, each SmartEdge within the selected cluster must set up a Core port or Core LAG. {infoLink}' }),
