      ...
      {isConnectionMeteringEnabled && <>
        ...
        { hasCloudpathAccess() && <>
          ...
          // eslint-disable-next-line max-len
            ...
            element={
              // eslint-disable-next-line max-len
              <PolicyAuthRoute policyType={PolicyType.CONNECTION_METERING} oper={PolicyOperation.CREATE}>
          ...
          // eslint-disable-next-line max-len
            ...
            element={
              // eslint-disable-next-line max-len
              <PolicyAuthRoute policyType={PolicyType.CONNECTION_METERING} oper={PolicyOperation.EDIT}>
