...
import {
  ...
  useLazyGetPersonaByIdQuery, useLazyGetPersonaGroupByIdQuery,
...
import {
  ...
  PropertyUnitStatus,
  UnitPersonaConfig, VenueLanPorts
...
export function UnitDrawer (props: UnitDrawerProps) {
  const { $t } = useIntl()
  ...
  const [defaultVlan] = useState(666)
        ...
        >
          {
            changeVlanField
              ...
              : <InputNumber min={1} max={4094} bordered={false} readOnly />
          }
        </Form.Item>
        {
          changeVlanField
