...
export const MessageMapping = {
  ...
  enable_r1_early_access_description: defineMessage({ defaultMessage: 'This option enables current and future early access features for this account across all venues, networks, and users. When {br} disabled, any configuration related to early access features will remain available until deleted. You may opt to remove features.' }),
