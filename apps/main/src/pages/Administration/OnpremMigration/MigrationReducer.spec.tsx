...
describe('MigrationReducer test', () => {
  it('should update the policy name when POLICYNAME action is dispatched', () => {
    ...
    const updatedState = migrationReducer(initState, action as SyslogActionPayload)
  ...
  it('should update the venue when VENUE related action is dispatched', () => {
    ...
    const updatedAddVenueState = migrationReducer(updatedState, addAction as SyslogActionPayload)
    ...
    // eslint-disable-next-line max-len
    const updatedRemoveVenueState = migrationReducer(updatedAddVenueState, removeAction as SyslogActionPayload)
