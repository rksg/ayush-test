...
describe('VersionBanner', () => {
  ...
  it('should render the latest firmware version by onboard date', async () => {
    ...
    expect(screen.getByText('07/27/2023')).toBeVisible()
    expect(screen.getByText('6.2.2.103.82')).toBeVisible()
    expect(screen.getByText('06/16/2023')).toBeVisible()
    expect(screen.getByText('6.2.0.103.518')).toBeVisible()
    expect(screen.getByText('07/21/2023')).toBeVisible()
  })
})
