    ...
    render(
      <Provider>
        <SwitchUpgradeWizard
          ...
          setVisible={mockedCancel}
          onSubmit={() => { }}
          data={switchVenue.upgradeVenueViewList.filter(item => item.name === 'My-Venue') as FirmwareSwitchVenue[]} />
      </Provider>, {
        route: { params, path: '/:tenantId/administration/fwVersionMgmt/switchFirmware' }
      })
    ...
    render(
      <Provider>
        <SwitchUpgradeWizard
          ...
          setVisible={mockedCancel}
          onSubmit={() => { }}
          data={switchVenue.upgradeVenueViewList.filter(item => item.name === 'Karen-Venue1') as FirmwareSwitchVenue[]} />
      </Provider>, {
        route: { params, path: '/:tenantId/administration/fwVersionMgmt/switchFirmware' }
      })
