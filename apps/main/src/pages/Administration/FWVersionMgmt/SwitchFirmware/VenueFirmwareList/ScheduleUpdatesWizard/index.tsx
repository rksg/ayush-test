...
export interface ScheduleUpdatesWizardProps {
  visible: boolean,
  onCancel: () => void,
...
export function ScheduleUpdatesWizard (props: ScheduleUpdatesWizardProps) {
  ...
  return <Modal
    title={$t({ defaultMessage: 'Schedule Updates' })}
    ...
    children={
      ...
      >
        ...
        <StepsForm.StepForm
          name='firmware'
          title={$t({ defaultMessage: 'Update Schedule' })}
        >
