...
jest.mock('@acx-ui/analytics/utils', () => ({
  ...
  useUserProfileContext: () => mockedProfile()
}))
...
describe('Layout', () => {
  ...
  it('should render layout correctly with multiple accounts', async () => {
    mockedProfile.mockImplementation(() => ({ data: {
      ...
      firstName: 'firstName',
      lastName: 'lastName',
      selectedTenant: { id: '0015000000GlI7SAAV', name: 'Company 2' }
    } }))
  ...
  it('should render layout correctly with single account', async () => {
    mockedProfile.mockImplementation(() => ({ data: {
      ...
      firstName: 'firstName',
      lastName: 'lastName',
      selectedTenant: { id: '0012h00000NrljgAAB', name: 'Company 1' }
    } }))
    render(<Layout />, { wrapper: Provider, route: { params: { tenantId: 'tenant-id' } } })
