...
export const apRebootReasonMap = {
  '/usr/sbin/cubic  application, cubic, reboot due to firmware change': defineMessage({
  ...
  'rsmd_func cubic monitor  AP lost Gateway more than 1800 seconds': defineMessage({
    defaultMessage: 'AP lost connection to gateway for more than 1800 seconds'
  }),
  'rsmd_func cubic monitor  AP lost SCG more than 7200 seconds': defineMessage({
    defaultMessage: 'AP lost connection to controller for more than 7200 seconds'
  }),
  '/usr/sbin/cubic  application, cubic, reboot due to ipmode change': defineMessage({
    defaultMessage: 'Reboot due to IP mode change'
  }),
  '/usr/sbin/cubic  application, cubic, reboot due to mesh mode change': defineMessage({
    defaultMessage: 'Reboot due to mesh mode change'
  }),
  '/usr/sbin/cubic  application, cubic, reboot due to WLAN migration': defineMessage({
    defaultMessage: 'Reboot due to WLAN migration'
  }),
  '/usr/sbin/cubic  application, cubic, reboot due to WLAN migration;application, cubic, Reboot due to firmware change': defineMessage({
    defaultMessage: 'Reboot due to WLAN migration or firmware change'
  }),
  '/usr/sbin/cubic  application, cubic, reboot due to enable mesh': defineMessage({
  ...
  '/usr/sbin/cubic  application, cubic, reboot due to enable mesh;application, cubic, reboot due to ipmode change': defineMessage({
    defaultMessage: 'Reboot due to IP mode change or mesh enablement'
  }),
  '/usr/sbin/cubic  application, cubic, reboot due to country code change': defineMessage({
    defaultMessage: 'Reboot due to country code change'
  }),
  '/usr/sbin/cubic  application, cubic, reboot due to firmware download can\'t be completed': defineMessage({
    defaultMessage: 'Reboot due to firmware download failure'
  }),
  '/usr/sbin/cubic  application, cubic, reboot due to enable mesh;application, cubic, reboot due to country code change': defineMessage({
    defaultMessage: 'Reboot due to mesh enablement or country code change'
  }),
  'application, cubic, reboot due to WLAN migration;application, cubic, reboot due to firmware change;': defineMessage({
    defaultMessage: 'Reboot due to WLAN migration or firmware change'
  }),
  'application, wsgclient, reboot due to firmware change': defineMessage({
    defaultMessage: 'Reboot due to firmware change'
  }),
  'rsmd_func cubic monitor  AP lost SCG more than 14400 seconds': defineMessage({
  ...
  '/usr/sbin/cubic  application, cubic, reboot due to WLAN migration;application, cubic, reboot due to firmware download can\'t be completed': defineMessage({
    defaultMessage: 'Reboot due to WLAN migration or firmware download failure'
  }),
  '/usr/sbin/cubic  application, cubic, reboot due to mesh mode change;application, cubic, reboot due to country code change': defineMessage({
  ...
  'application, cubic, reboot due to firmware change;': defineMessage({
    defaultMessage: 'Reboot due to firmware change'
  }),
