...
import { FooterWithDivider }                                                    from 'src/components/PageHeader/FooterWithDivider'
import { Table }                                                                from 'src/components/Table'
import { VLAN_PREFIX, NetworkTypeEnum, GuestNetworkTypeEnum, WlanSecurityEnum } from 'src/utils/rc'
...
export function NetworksTable () {
  const NetworksTable = () => {
    ...
    const { data, error, isLoading, refetch } = useNetworkListQuery(payload)
  ...
  return <>
    <PageHeader
      title='Networks'
      footer={
        <FooterWithDivider extra={[
          <Link to={routeToPath('/networks/create')}><Button>Add Network</Button></Link>
        ]}>
          <div />
        </FooterWithDivider>
      }
