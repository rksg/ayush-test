...
import { ClusterNetworkSettings, EdgeAlarmSummary, EdgeLag, EdgeLagStatus, EdgePort, EdgePortStatus, EdgePortWithStatus, EdgeSerialNumber, EdgeStatus, EdgeSubInterface, PRODUCT_CODE_VIRTUAL_EDGE } from '../../types'
