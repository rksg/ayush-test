...
export enum PolicyType {
  ...
  ACCESS_CONTROL_CONSOLIDATION = 'Access Control Consolidation',
...
export const policyTypeDescMapping: Record<PolicyType, MessageDescriptor> = {
  ...
  [PolicyType.ACCESS_CONTROL_CONSOLIDATION]: defineMessage({ defaultMessage: 'Create L2-L7 access policies for device access to wireless or switch networks' }),
