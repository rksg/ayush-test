...
export function RadioSettings (props: ApGroupRadioConfigItemProps) {
  ...
  const { data: venueBandModeSavedData } =
  ...
  return (
    <Loader states={[{
      isLoading: isLoadingVenueData || (isWifiSwitchableRfEnabled && (isLoadingSupportChannelsData || isLoadingTripleBandRadioSettingsData || isLoadingApGroupBandModeData || isLoadingApGroupData)),
