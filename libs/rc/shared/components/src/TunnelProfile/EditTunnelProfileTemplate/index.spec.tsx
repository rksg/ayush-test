...
import { EdgeConfigTemplateApi, edgeSdLanApi, pinApi }                                                                                             from '@acx-ui/rc/services'
import { EdgeConfigTemplateUrlsInfo, EdgeGeneralFixtures, EdgePinUrls, EdgeSdLanFixtures, EdgeSdLanUrls, EdgeTunnelProfileFixtures, EdgeUrlsInfo } from '@acx-ui/rc/utils'
import { Provider, store }                                                                                                                         from '@acx-ui/store'
import { mockServer, render, screen, waitFor, waitForElementToBeRemoved }                                                                          from '@acx-ui/test-utils'

import { EditTunnelProfileTemplate } from '.'
...
describe('EditTunnelProfileTemplate', () => {
  ...
  beforeEach(() => {
    ...
    store.dispatch(EdgeConfigTemplateApi.util.resetApiState())

    mockServer.use(
      rest.put(
        EdgeConfigTemplateUrlsInfo.updateTunnelProfileTemplate.url,
        (_req, res, ctx) => res(ctx.status(202))
      ),
      rest.get(
        EdgeConfigTemplateUrlsInfo.getTunnelProfileTemplate.url,
