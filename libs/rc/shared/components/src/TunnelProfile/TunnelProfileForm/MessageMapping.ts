...
export const MessageMapping = {
  ...
  keep_alive_interval_tooltip: defineMessage({ defaultMessage: 'The interval at which AP sends keep-alive requests to SmartEdge.' }),
  keep_alive_retry_tooltip: defineMessage({ defaultMessage: 'The consecutive number of keep-alive requests that can be lost before disconnecting from SmartEdge.' })
}