...
export const MessageMapping = {
  ...
  network_segment_type_tooltip: defineMessage({ defaultMessage: 'The Personal Identity Network service uses VxLAN (VNI) tunneling, and the SD-LAN service maps VLAN to VNI for tunneling. Please choose the correct option for your service.' }),
