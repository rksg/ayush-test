...
export function BackgroundContent (props: BackgroundContentProps){
  ...
  const content = <div>
    <Space direction='vertical'>
      <UI.PopoverButton style={{ marginBottom: 10, position: 'relative', zIndex: 2 }}
        onClick={()=>{
    ...
    placeholder='bgcolorpicker'>
      ...
      >
        <UI.PopoverButton onClick={(e)=>{
          e.preventDefault()
        }}><label htmlFor='bgimageupload' style={{ fontSize: 14, position: 'relative', zIndex: 2 }}>
