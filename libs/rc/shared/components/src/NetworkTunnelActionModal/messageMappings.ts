...
export const messageMappings = {
  ...
  softgre_ipsec_setting_info: defineMessage({ defaultMessage: 'A <venueSingular></venueSingular> supports up to <b>3 SoftGRE activated profiles without IPsec</b> or 1 SoftGRE with IPsec.' })
}
