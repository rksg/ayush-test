...
import {
  ...
  useLazyGetApFeatureSetsQuery }   from '@acx-ui/rc/services'
import {
  ApCompatibility,
...
export type OldApCompatibilityDrawerProps = {
  visible: boolean,
...
export const OldApCompatibilityDrawer = (props: OldApCompatibilityDrawerProps) => {
  ...
  const [ apCompatibilities, setApCompatibilities ] = useState<ApCompatibility[] | Compatibility[]>(data)
