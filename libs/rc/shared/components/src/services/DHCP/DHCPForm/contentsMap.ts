...
export const dhcpTypesDesc: Record<DHCPConfigTypeEnum, MessageDescriptor> = {
  [DHCPConfigTypeEnum.SIMPLE]: defineMessage({
    defaultMessage: `
    Each AP in this <venueSingular></venueSingular> is running it’s own DHCP server instance.
  ...
  [DHCPConfigTypeEnum.MULTIPLE]: defineMessage({
    defaultMessage: `
    Designated APs in this <venueSingular></venueSingular> are running the DHCP Server instance.
