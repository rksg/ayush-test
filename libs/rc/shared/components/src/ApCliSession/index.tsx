...
import { UIDraggable, UIModal, UIResizableBox } from './styledComponents'

import type { DraggableData, DraggableEvent } from 'react-draggable'
import type { ResizeCallbackData }            from 'react-resizable'

export function ApCliSession (props: {
  modalState: boolean,
  ...
  return (
    <UIModal
      title={
        <div
          data-testid='apCliSessionModalDiv'
          style={{
            padding: '0px',
            width: '100%',
            cursor: 'move'
      ...
      modalRender={(modal) => (
        ...
        >
          <div data-testid='apCliSessionDraggableRef' ref={draggleRef}>{modal}</div>
        </UIDraggable>
      )}
      width={width}
    >
      ...
      >
        <div
          ...
          data-testid='apCliSessionDialogWrapper'
