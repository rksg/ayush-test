...
export const messageMapping = {
  ...
  gateway_dhcp_option_tooltip: defineMessage({ defaultMessage: 'Set the DHCP Option 43 subcode that will be used to discover the address of the security gateway on the network. Available range is 1-32.' }),
