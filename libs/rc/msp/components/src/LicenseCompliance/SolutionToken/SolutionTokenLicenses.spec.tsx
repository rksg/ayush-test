...
import SolutionTokenLicenses from './SolutionTokenLicenses'
...
describe('SolutionTokenLicenses', () => {
  ...
  it('should show columns with FF enabled', async () => {
    render(
      <Provider>
        <SolutionTokenLicenses />
      </Provider>, {
    ...
    jest.mocked(useIsSplitOn).mockImplementation(ff =>
      ff === Features.ENTITLEMENT_ADAPTIVE_POLICY_TOGGLE)

    jest.mocked(useIsSplitOn).mockImplementation(ff =>
      ff === Features.ENTITLEMENT_PMS_INTEGRATION_TOGGLE)

    expect(await screen.findByText('PMS Integration')).toBeVisible()
  })
})
