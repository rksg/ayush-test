...
import { DHCP_OPTION_TYPE, STACK_MEMBERSHIP, SwitchRow, SwitchStatusEnum, SwitchViewModel } from '../../types'
...
export const getDhcpOptionList = () => {
  ...
  const DHCP_OPTIONS_ACX = {
    ...
    79: { label: $t({ defaultMessage: 'Service Scope' }), value: 79, type: ALL_TYPE_ACX },
    80: { label: $t({ defaultMessage: 'Rapid Commit' }), value: 80, type: ALL_TYPE_ACX },
    81: { label: $t({ defaultMessage: 'Client FQDN' }), value: 81, type: ALL_TYPE_ACX },
    83: { label: $t({ defaultMessage: 'iSNS' }), value: 83, type: [DHCP_OPTION_TYPE.IP] },
    84: { label: $t({ defaultMessage: 'REMOVED/Unassigned' }), value: 84, type: ALL_TYPE_ACX },
    ...
    90: { label: $t({ defaultMessage: 'Authentication' }), value: 90, type: ALL_TYPE_ACX },
    ...
    94: { label: $t({ defaultMessage: 'Client NDI' }), value: 94, type: ALL_TYPE_ACX },
    95: { label: $t({ defaultMessage: 'LDAP' }), value: 95, type: ALL_TYPE_ACX },
    96: { label: $t({ defaultMessage: 'REMOVED/Unassigned' }), value: 96, type: ALL_TYPE_ACX },
    97: { label: $t({ defaultMessage: 'UUID/GUID' }), value: 97, type: ALL_TYPE_ACX },
    98: { label: $t({ defaultMessage: 'User-Auth' }), value: 98, type: [DHCP_OPTION_TYPE.ASCII] },
    99: { label: $t({ defaultMessage: 'GEOCONF_CIVIC' }), value: 99, type: ALL_TYPE_ACX },
    ...
    102: { label: $t({ defaultMessage: 'Removed/Unassigned' }), value: 102, type: ALL_TYPE_ACX },
    103: { label: $t({ defaultMessage: 'Removed/Unassigned' }), value: 103, type: ALL_TYPE_ACX },
    104: { label: $t({ defaultMessage: 'Removed/Unassigned' }), value: 104, type: ALL_TYPE_ACX },
    105: { label: $t({ defaultMessage: 'Removed/Unassigned' }), value: 105, type: ALL_TYPE_ACX },
    106: { label: $t({ defaultMessage: 'Removed/Unassigned' }), value: 106, type: ALL_TYPE_ACX },
    107: { label: $t({ defaultMessage: 'Removed/Unassigned' }), value: 107, type: ALL_TYPE_ACX },
    108: { label: $t({ defaultMessage: 'Removed/Unassigned' }), value: 108, type: ALL_TYPE_ACX },
    109: { label: $t({ defaultMessage: 'Removed/Unassigned' }), value: 109, type: ALL_TYPE_ACX },
    110: { label: $t({ defaultMessage: 'Removed/Unassigned' }), value: 110, type: ALL_TYPE_ACX },
    111: { label: $t({ defaultMessage: 'Removed/Unassigned' }), value: 111, type: ALL_TYPE_ACX },
    ...
    115: { label: $t({ defaultMessage: 'REMOVED/Unassigned' }), value: 115, type: ALL_TYPE_ACX },
    116: { label: $t({ defaultMessage: 'Auto-Config' }), value: 116, type: ALL_TYPE_ACX },
    117: { label: $t({ defaultMessage: 'Name Service Search' }), value: 117, type: ALL_TYPE_ACX },
    ...
    120: { label: $t({ defaultMessage: 'SIP Servers' }), value: 120, type: ALL_TYPE_ACX },
    121: { label: $t({ defaultMessage: 'Classless Static Route Option' }), value: 121, type: ALL_TYPE_ACX },
    122: { label: $t({ defaultMessage: 'CCC' }), value: 122, type: ALL_TYPE_ACX },
    123: { label: $t({ defaultMessage: 'GeoConf Option' }), value: 123, type: ALL_TYPE_ACX },
    124: { label: $t({ defaultMessage: 'V-I Vendor Class' }), value: 124, type: ALL_TYPE_ACX },
    125: { label: $t({ defaultMessage: 'V-I VendorSpeciInfo' }), value: 125, type: [DHCP_OPTION_TYPE.ASCII] },
    126: { label: $t({ defaultMessage: 'Removed/Unassigned' }), value: 126, type: ALL_TYPE_ACX },
    127: { label: $t({ defaultMessage: 'Removed/Unassigned' }), value: 127, type: ALL_TYPE_ACX },
    128: { label: $t({ defaultMessage: 'PXE-VendorSpecific' }), value: 128, type: ALL_TYPE_ACX },
    129: { label: $t({ defaultMessage: 'PXE-VendorSpecific' }), value: 129, type: ALL_TYPE_ACX },
    130: { label: $t({ defaultMessage: 'PXE-VendorSpecific' }), value: 130, type: ALL_TYPE_ACX },
    131: { label: $t({ defaultMessage: 'PXE-VendorSpecific' }), value: 131, type: ALL_TYPE_ACX },
    132: { label: $t({ defaultMessage: 'PXE-VendorSpecific' }), value: 132, type: ALL_TYPE_ACX },
    133: { label: $t({ defaultMessage: 'PXE-VendorSpecific' }), value: 133, type: ALL_TYPE_ACX },
    134: { label: $t({ defaultMessage: 'PXE-VendorSpecific' }), value: 134, type: ALL_TYPE_ACX },
    135: { label: $t({ defaultMessage: 'PXE-VendorSpecific' }), value: 135, type: ALL_TYPE_ACX },
    136: { label: $t({ defaultMessage: 'OPTION_PANA_AGENT' }), value: 136, type: ALL_TYPE_ACX },
    ...
    139: { label: $t({ defaultMessage: 'OPTION-IPv4_Address-MoS' }), value: 139, type: ALL_TYPE_ACX },
    140: { label: $t({ defaultMessage: 'OPTION-IPv4_FQDN-MoS' }), value: 140, type: ALL_TYPE_ACX },
    ...
    143: { label: $t({ defaultMessage: 'OPTION_V4_SZTP_REDIRECT' }), value: 143, type: ALL_TYPE_ACX },
    144: { label: $t({ defaultMessage: 'GeoLoc' }), value: 144, type: ALL_TYPE_ACX },
    145: { label: $t({ defaultMessage: 'FORCERENEW_NONCE_CAPABLE' }), value: 145, type: ALL_TYPE_ACX },
    146: { label: $t({ defaultMessage: 'RDNSS Selection' }), value: 146, type: ALL_TYPE_ACX },
    147: { label: $t({ defaultMessage: 'Unassigned' }), value: 147, type: ALL_TYPE_ACX },
    148: { label: $t({ defaultMessage: 'Unassigned' }), value: 148, type: ALL_TYPE_ACX },
    149: { label: $t({ defaultMessage: 'Unassigned' }), value: 149, type: ALL_TYPE_ACX },
    150: { label: $t({ defaultMessage: 'TFTP Server Addr' }), value: 150, type: [DHCP_OPTION_TYPE.IP] },
    151: { label: $t({ defaultMessage: 'status-code' }), value: 151, type: ALL_TYPE_ACX },
    152: { label: $t({ defaultMessage: 'base-time' }), value: 152, type: ALL_TYPE_ACX },
    153: { label: $t({ defaultMessage: 'start-time-of-state' }), value: 153, type: ALL_TYPE_ACX },
    154: { label: $t({ defaultMessage: 'query-start-time' }), value: 154, type: ALL_TYPE_ACX },
    155: { label: $t({ defaultMessage: 'query-end-time' }), value: 155, type: ALL_TYPE_ACX },
    156: { label: $t({ defaultMessage: 'dhcp-state' }), value: 156, type: ALL_TYPE_ACX },
    157: { label: $t({ defaultMessage: 'data-source' }), value: 157, type: ALL_TYPE_ACX },
    158: { label: $t({ defaultMessage: 'OPTION_V4_PCP_SERVER' }), value: 158, type: ALL_TYPE_ACX },
    159: { label: $t({ defaultMessage: 'OPTION_V4_PORTPARAMS' }), value: 159, type: ALL_TYPE_ACX },
    160: { label: $t({ defaultMessage: 'Captive-Portal' }), value: 160, type: ALL_TYPE_ACX },
    161: { label: $t({ defaultMessage: 'Unassigned' }), value: 161, type: ALL_TYPE_ACX },
    162: { label: $t({ defaultMessage: 'Unassigned' }), value: 162, type: ALL_TYPE_ACX },
    163: { label: $t({ defaultMessage: 'Unassigned' }), value: 163, type: ALL_TYPE_ACX },
    164: { label: $t({ defaultMessage: 'Unassigned' }), value: 164, type: ALL_TYPE_ACX },
    165: { label: $t({ defaultMessage: 'Unassigned' }), value: 165, type: ALL_TYPE_ACX },
    166: { label: $t({ defaultMessage: 'Unassigned' }), value: 166, type: ALL_TYPE_ACX },
    167: { label: $t({ defaultMessage: 'Unassigned' }), value: 167, type: ALL_TYPE_ACX },
    168: { label: $t({ defaultMessage: 'Unassigned' }), value: 168, type: ALL_TYPE_ACX },
    169: { label: $t({ defaultMessage: 'Unassigned' }), value: 169, type: ALL_TYPE_ACX },
    170: { label: $t({ defaultMessage: 'Unassigned' }), value: 170, type: ALL_TYPE_ACX },
    171: { label: $t({ defaultMessage: 'Unassigned' }), value: 171, type: ALL_TYPE_ACX },
    172: { label: $t({ defaultMessage: 'Unassigned' }), value: 172, type: ALL_TYPE_ACX },
    173: { label: $t({ defaultMessage: 'Unassigned' }), value: 173, type: ALL_TYPE_ACX },
    174: { label: $t({ defaultMessage: 'Unassigned' }), value: 174, type: ALL_TYPE_ACX },
    175: { label: $t({ defaultMessage: 'Etherboot' }), value: 175, type: ALL_TYPE_ACX },
    176: { label: $t({ defaultMessage: 'IP Tele-VoiceSrvr' }), value: 176, type: [DHCP_OPTION_TYPE.IP] },
    177: { label: $t({ defaultMessage: 'PktCable-CableHome' }), value: 177, type: ALL_TYPE_ACX },
    178: { label: $t({ defaultMessage: 'Unassigned' }), value: 178, type: ALL_TYPE_ACX },
    179: { label: $t({ defaultMessage: 'Unassigned' }), value: 179, type: ALL_TYPE_ACX },
    180: { label: $t({ defaultMessage: 'Unassigned' }), value: 180, type: ALL_TYPE_ACX },
    181: { label: $t({ defaultMessage: 'Unassigned' }), value: 181, type: ALL_TYPE_ACX },
    182: { label: $t({ defaultMessage: 'Unassigned' }), value: 182, type: ALL_TYPE_ACX },
    183: { label: $t({ defaultMessage: 'Unassigned' }), value: 183, type: ALL_TYPE_ACX },
    184: { label: $t({ defaultMessage: 'Unassigned' }), value: 184, type: ALL_TYPE_ACX },
    185: { label: $t({ defaultMessage: 'Unassigned' }), value: 185, type: ALL_TYPE_ACX },
    186: { label: $t({ defaultMessage: 'Unassigned' }), value: 186, type: ALL_TYPE_ACX },
    187: { label: $t({ defaultMessage: 'Unassigned' }), value: 187, type: ALL_TYPE_ACX },
    188: { label: $t({ defaultMessage: 'Unassigned' }), value: 188, type: ALL_TYPE_ACX },
    189: { label: $t({ defaultMessage: 'Unassigned' }), value: 189, type: ALL_TYPE_ACX },
    190: { label: $t({ defaultMessage: 'Unassigned' }), value: 190, type: ALL_TYPE_ACX },
    191: { label: $t({ defaultMessage: 'Unassigned' }), value: 191, type: ALL_TYPE_ACX },
    192: { label: $t({ defaultMessage: 'Unassigned' }), value: 192, type: ALL_TYPE_ACX },
    193: { label: $t({ defaultMessage: 'Unassigned' }), value: 193, type: ALL_TYPE_ACX },
    194: { label: $t({ defaultMessage: 'Unassigned' }), value: 194, type: ALL_TYPE_ACX },
    195: { label: $t({ defaultMessage: 'Unassigned' }), value: 195, type: ALL_TYPE_ACX },
    196: { label: $t({ defaultMessage: 'Unassigned' }), value: 196, type: ALL_TYPE_ACX },
    197: { label: $t({ defaultMessage: 'Unassigned' }), value: 197, type: ALL_TYPE_ACX },
    198: { label: $t({ defaultMessage: 'Unassigned' }), value: 198, type: ALL_TYPE_ACX },
    199: { label: $t({ defaultMessage: 'Unassigned' }), value: 199, type: ALL_TYPE_ACX },
    200: { label: $t({ defaultMessage: 'Unassigned' }), value: 200, type: ALL_TYPE_ACX },
    201: { label: $t({ defaultMessage: 'Unassigned' }), value: 201, type: ALL_TYPE_ACX },
    202: { label: $t({ defaultMessage: 'Unassigned' }), value: 202, type: ALL_TYPE_ACX },
    203: { label: $t({ defaultMessage: 'Unassigned' }), value: 203, type: ALL_TYPE_ACX },
    204: { label: $t({ defaultMessage: 'Unassigned' }), value: 204, type: ALL_TYPE_ACX },
    205: { label: $t({ defaultMessage: 'Unassigned' }), value: 205, type: ALL_TYPE_ACX },
    206: { label: $t({ defaultMessage: 'Unassigned' }), value: 206, type: ALL_TYPE_ACX },
    207: { label: $t({ defaultMessage: 'Unassigned' }), value: 207, type: ALL_TYPE_ACX },
    208: { label: $t({ defaultMessage: 'PXELINUX Magic' }), value: 208, type: ALL_TYPE_ACX },
    ...
    211: { label: $t({ defaultMessage: 'Reboot Time' }), value: 211, type: ALL_TYPE_ACX },
    212: { label: $t({ defaultMessage: 'OPTION_6RD' }), value: 212, type: ALL_TYPE_ACX },
    213: { label: $t({ defaultMessage: 'V4_ACCESS_DOMAIN' }), value: 213, type: [DHCP_OPTION_TYPE.ASCII] },
    214: { label: $t({ defaultMessage: 'Unassigned' }), value: 214, type: ALL_TYPE_ACX },
    215: { label: $t({ defaultMessage: 'Unassigned' }), value: 215, type: ALL_TYPE_ACX },
    216: { label: $t({ defaultMessage: 'Unassigned' }), value: 216, type: ALL_TYPE_ACX },
    217: { label: $t({ defaultMessage: 'Unassigned' }), value: 217, type: ALL_TYPE_ACX },
    218: { label: $t({ defaultMessage: 'Unassigned' }), value: 218, type: ALL_TYPE_ACX },
    219: { label: $t({ defaultMessage: 'Unassigned' }), value: 219, type: ALL_TYPE_ACX },
    220: { label: $t({ defaultMessage: 'Subnet Allocation Option' }), value: 220, type: ALL_TYPE_ACX },
    221: { label: $t({ defaultMessage: 'VSS' }), value: 221, type: ALL_TYPE_ACX },
    222: { label: $t({ defaultMessage: 'Unassigned' }), value: 222, type: ALL_TYPE_ACX },
    223: { label: $t({ defaultMessage: 'Unassigned' }), value: 223, type: ALL_TYPE_ACX },
    224: { label: $t({ defaultMessage: 'Reserved' }), value: 224, type: ALL_TYPE_ACX },
    225: { label: $t({ defaultMessage: 'Reserved' }), value: 225, type: ALL_TYPE_ACX },
    226: { label: $t({ defaultMessage: 'Reserved' }), value: 226, type: ALL_TYPE_ACX },
    227: { label: $t({ defaultMessage: 'Reserved' }), value: 227, type: ALL_TYPE_ACX },
    228: { label: $t({ defaultMessage: 'Reserved' }), value: 228, type: ALL_TYPE_ACX },
    229: { label: $t({ defaultMessage: 'Reserved' }), value: 229, type: ALL_TYPE_ACX },
    230: { label: $t({ defaultMessage: 'Reserved' }), value: 230, type: ALL_TYPE_ACX },
    231: { label: $t({ defaultMessage: 'Reserved' }), value: 231, type: ALL_TYPE_ACX },
    232: { label: $t({ defaultMessage: 'Reserved' }), value: 232, type: ALL_TYPE_ACX },
    233: { label: $t({ defaultMessage: 'Reserved' }), value: 233, type: ALL_TYPE_ACX },
    234: { label: $t({ defaultMessage: 'Reserved' }), value: 234, type: ALL_TYPE_ACX },
    235: { label: $t({ defaultMessage: 'Reserved' }), value: 235, type: ALL_TYPE_ACX },
    236: { label: $t({ defaultMessage: 'Reserved' }), value: 236, type: ALL_TYPE_ACX },
    237: { label: $t({ defaultMessage: 'Reserved' }), value: 237, type: ALL_TYPE_ACX },
    238: { label: $t({ defaultMessage: 'Reserved' }), value: 238, type: ALL_TYPE_ACX },
    239: { label: $t({ defaultMessage: 'Reserved' }), value: 239, type: ALL_TYPE_ACX },
    240: { label: $t({ defaultMessage: 'Reserved' }), value: 240, type: ALL_TYPE_ACX },
    241: { label: $t({ defaultMessage: 'Reserved' }), value: 241, type: ALL_TYPE_ACX },
    242: { label: $t({ defaultMessage: 'IP Tele-DataSrvr' }), value: 242, type: [DHCP_OPTION_TYPE.IP] },
    243: { label: $t({ defaultMessage: 'Reserved' }), value: 243, type: ALL_TYPE_ACX },
    244: { label: $t({ defaultMessage: 'Reserved' }), value: 244, type: ALL_TYPE_ACX },
    245: { label: $t({ defaultMessage: 'Reserved' }), value: 245, type: ALL_TYPE_ACX },
    246: { label: $t({ defaultMessage: 'Reserved' }), value: 246, type: ALL_TYPE_ACX },
    247: { label: $t({ defaultMessage: 'Reserved' }), value: 247, type: ALL_TYPE_ACX },
    248: { label: $t({ defaultMessage: 'Reserved' }), value: 248, type: ALL_TYPE_ACX },
    249: { label: $t({ defaultMessage: 'Reserved' }), value: 249, type: ALL_TYPE_ACX },
    250: { label: $t({ defaultMessage: 'Reserved' }), value: 250, type: ALL_TYPE_ACX },
    251: { label: $t({ defaultMessage: 'Reserved' }), value: 251, type: ALL_TYPE_ACX },
    252: { label: $t({ defaultMessage: 'WPAD' }), value: 252, type: [DHCP_OPTION_TYPE.ASCII] },
    253: { label: $t({ defaultMessage: 'Reserved' }), value: 253, type: ALL_TYPE_ACX },
    254: { label: $t({ defaultMessage: 'Reserved' }), value: 254, type: ALL_TYPE_ACX }
  }

  return DHCP_OPTIONS_ACX
}