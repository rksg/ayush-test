...
import { ProfileTypeEnum,
  ConfigurationBackupStatus, PortLabelType, PortTaggedEnum, TrustedPortTypeEnum
} from './constants'
...
export const SWITCH_SERIAL_8100X = '(FPM|FPP|FPQ|FPR|FPS|FPT|FPU)'
