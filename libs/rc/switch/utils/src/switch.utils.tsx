...
export const ICX_MODELS_MODULES = {
  ...
  ICX7550: {
    ...
    '24ZP': [['24X2.5/10G'], ['2X40G'], ['1X100G', '2X40G', '4X10GF', '4X25G']],
    '48ZP': [['48X2.5/10G'], ['2X40G'], ['1X100G', '2X40G', '4X10GF', '4X25G']],
    '24F': [['24X10G'], ['2X40G'], ['1X100G', '2X40G', '4X10GF', '4X25G']],
    '48F': [['48X1/10G'], ['2X40G'], ['1X100G', '2X40G', '4X10GF', '4X25G']],
...
export const isFirmwareVersionAbove10010h = function (firmwareVersion?: string) {
  /*
  Only support the firmware versions listed below:
  1. > 10010h
  */
  if (firmwareVersion) {
    return isVerGEVer(firmwareVersion, '10010h', false)
  } else {
    return false
  }
}
