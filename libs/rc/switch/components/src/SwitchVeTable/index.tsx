...
import { isFirmwareVersionAbove10010hLower10020, isOperationalSwitch } from '@acx-ui/rc/switch/utils'
import {
  VenueMessages,
  VeViewModel,
  SwitchViewModel,
...
export function SwitchVeTable (props: {
  ...
  const isActionHidden = (data?: VeViewModel[]) => {
    if(!isVenueLevel && switchDetail?.model?.startsWith('ICX8100')){
      if(isFirmwareVersionAbove10010hLower10020(switchDetail?.firmware)){
