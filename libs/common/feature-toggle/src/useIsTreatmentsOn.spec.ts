...
import { useIsTreatmentsOn } from './useIsTreatmentsOn'
...
describe('useIsTreatmentsOn', () => {
  it('returns flag is on/off correctly', () => {
    ...
    const { rerender, result } = renderHook(() => useIsTreatmentsOn(['ff1', 'ff2']))
  ...
  it('handle input with string instead of string[]', () => {
    ...
    const { rerender, result } = renderHook(() => useIsTreatmentsOn('ff1'))
