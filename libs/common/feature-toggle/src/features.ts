...
export const BetaListDetails:BetaList[] = [
  ...
  { key: TierFeatures.EDGE_ADV, description: defineMessage({ defaultMessage: 'Personal Identity Networks: Powered by RUCKUS Edge, Personal Identity Networks (PIN) uses VxLAN tunneling to extend network identities to the Edge, creating seamless connectivity across the network domain. It enables identities to securely access their networks and connected devices while also establishing Personal Area Networks (PAN) for secure, individualized connectivity.' }), status: true },
  // for testing only
