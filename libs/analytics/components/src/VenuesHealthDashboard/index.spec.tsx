...
describe('HealthWidget', () => {
  ...
  it('should render loader', () => {
    ...
    render( <Provider> <VenuesHealthDashboard filters={filters}/></Provider>, {
  ...
  it('should render for empty data', async () => {
    ...
    await screen.findByText('Top Venues/Services with poor experience')
  ...
  it('should render widget with proper data', async () => {
    ...
    const { asFragment } = render( <Provider> <VenuesHealthDashboard
