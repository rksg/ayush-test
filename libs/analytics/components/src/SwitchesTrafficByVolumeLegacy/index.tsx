...
import {
  useSwitchesTrafficByVolumeLegacyQuery,
  SwitchesTrafficByVolumeData
} from './services'

type Key = keyof Omit<SwitchesTrafficByVolumeData, 'time'>

SwitchesTrafficByVolumeLegacy.defaultProps = {
  vizType: 'line'
}

export function SwitchesTrafficByVolumeLegacy ({
  ...
  const queryResults = useSwitchesTrafficByVolumeLegacyQuery(filters, {
