...
export const statusTrailMsgs: Record<string, MessageDescriptor> = {
  new: defineMessage({ defaultMessage: 'New' }),
  applyscheduled: defineMessage({ defaultMessage: 'Scheduled' }),
  applyscheduleinprogress: defineMessage({ defaultMessage: 'Apply In Progress' }),
  applied: defineMessage({ defaultMessage: 'Applied' }),
  applyfailed: defineMessage({ defaultMessage: 'Failed' }),
  beforeapplyinterrupted:
    defineMessage({ defaultMessage: 'Interrupted (Recommendation not applied' }),
  afterapplyinterrupted: defineMessage({ defaultMessage: 'Interrupted (Recommendation applied)' }),
  applywarning: defineMessage({ defaultMessage: 'REVERT' }),
  revertscheduled: defineMessage({ defaultMessage: 'Revert Scheduled' }),
  revertscheduleinprogress: defineMessage({ defaultMessage: 'Revert In Progress' }),
  revertfailed: defineMessage({ defaultMessage: 'Revert Failed' }),
  reverted: defineMessage({ defaultMessage: 'Reverted' })
}
