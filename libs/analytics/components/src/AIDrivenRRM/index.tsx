...
function AIDrivenRRMWidget ({
  ...
  const subtitle = $t({ defaultMessage: 'There are recommendations for {total} {total, plural, one {venue} other {venues}} covering {totalScenarios} possible RRM combinations. Currently {optimized} out of {total} {total, plural, one {venue} other {venues}} have been optimized.' }, { total, optimized, totalScenarios })
  // eslint-disable-next-line max-len
  const subtitleRA = $t({ defaultMessage: 'There are recommendations for {total} {total, plural, one {zone} other {zones}} covering {totalScenarios} possible RRM combinations. Currently {optimized} out of {total} {total, plural, one {zone} other {zones}} have been optimized.' }, { total, optimized, totalScenarios })
  // eslint-disable-next-line max-len
  ...
  return <Loader states={[queryResults]}>
    <Card
      ...
      subTitle={noData ? noCrrmText : (isMLISA ? subtitleRA : subtitle)
      }>{
        noData
