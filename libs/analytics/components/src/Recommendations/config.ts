...
export const codes = {
  ...
  'c-crrm-channel24g-auto': {
    ...
    appliedReasonText: defineMessage({ defaultMessage: 'AI-Driven Cloud RRM will constantly monitor the network, and adjust the channel plan, bandwidth and AP transmit power when necessary to provide position gains within the multiple dimensions of reliability, speed throughput, more compatibility, better coverage, with minimal co-channel interference, and gains in packet error/retry rates. These changes, if any, will be indicated by the Key Performance Indicators. The number of interfering links may also fluctuate, depending on any changes in the network, configurations and/or rogue AP activities.' }),
    tradeoffText: get('IS_MLISA_SA')
      ? defineMessage({ defaultMessage: 'AI-Driven Cloud RRM will be applied at the zone level, and all configurations (including static configurations) for channel, channel bandwidth, Auto Channel Selection, Auto Cell Sizing and AP transmit power will potentially be overwritten. While the improvement will provide positive gains within multiple dimensions of reliability, speed throughput, more compatibility, better coverage, there can be occasional minor decrements in few of those categories to balance overall network optimization in few scenarios. Do note that any unlicensed APs added to the zone after AI-Driven Cloud RRM is applied will not be considered and this may result in suboptimal channel planning in the zone.' })
      : defineMessage({ defaultMessage: 'AI-Driven Cloud RRM will be applied at the venue level, and all configurations (including static configurations) for channel, channel bandwidth, Auto Channel Selection, Auto Cell Sizing and AP transmit power will potentially be overwritten. While the improvement will provide positive gains within multiple dimensions of reliability, speed throughput, more compatibility, better coverage, there can be occasional minor decrements in few of those categories to balance overall network optimization in few scenarios.' }),
    kpis: [{
  ...
  'c-crrm-channel5g-auto': {
    ...
    appliedReasonText: defineMessage({ defaultMessage: 'AI-Driven Cloud RRM will constantly monitor the network, and adjust the channel plan, bandwidth and AP transmit power when necessary to provide position gains within the multiple dimensions of reliability, speed throughput, more compatibility, better coverage, with minimal co-channel interference, and gains in packet error/retry rates. These changes, if any, will be indicated by the Key Performance Indicators. The number of interfering links may also fluctuate, depending on any changes in the network, configurations and/or rogue AP activities.' }),
    tradeoffText: get('IS_MLISA_SA')
      ? defineMessage({ defaultMessage: 'AI-Driven Cloud RRM will be applied at the zone level, and all configurations (including static configurations) for channel, channel bandwidth, Auto Channel Selection, Auto Cell Sizing and AP transmit power will potentially be overwritten. While the improvement will provide positive gains within multiple dimensions of reliability, speed throughput, more compatibility, better coverage, there can be occasional minor decrements in few of those categories to balance overall network optimization in few scenarios. DFS channels with excessive radar events will also be automatically restricted from usage. Do note that any unlicensed APs added to the zone after AI-Driven Cloud RRM is applied will not be considered and this may result in suboptimal channel planning in the zone.' })
      : defineMessage({ defaultMessage: 'AI-Driven Cloud RRM will be applied at the venue level, and all configurations (including static configurations) for channel, channel bandwidth, Auto Channel Selection, Auto Cell Sizing and AP transmit power will potentially be overwritten. While the improvement will provide positive gains within multiple dimensions of reliability, speed throughput, more compatibility, better coverage, there can be occasional minor decrements in few of those categories to balance overall network optimization in few scenarios. DFS channels with excessive radar events will also be automatically restricted from usage.' }),
    kpis: [{
      key: 'number-of-interfering-links',
      label: defineMessage({ defaultMessage: 'Number of Interfering Links' }),
      format: formatter('countFormat'),
