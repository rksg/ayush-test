  ...
  const tabDetails: ContentSwitcherProps['tabDetails'] = [
    {
      ...
      children: <Card
        type='no-border'
        title={$t({ defaultMessage: 'Top {count} Impacted {type}' },
    ...
    },
    {
      ...
      >
        <AutoSizer>
          {({ height, width }) => (
            getHealthPieChart(wlans, height, width, formatter('durationFormat'))
          )}
        </AutoSizer>
      </Card>
    }
