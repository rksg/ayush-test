...
describe('AIOperations dashboard', () => {
  ...
  it('renders no data for switch path', async () => {
    ...
    expect(await screen.findByText('Your network is already running in an optimal configuration and we dont have any AI Operations to recommend recently.')).toBeVisible()
  })
