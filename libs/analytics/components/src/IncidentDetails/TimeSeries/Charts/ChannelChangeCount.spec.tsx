...
import { fakeIncidentChannelDist, fakeIncident } from '@acx-ui/analytics/utils'
...
import { ChannelChangeCount } from './ChannelChangeCount'

const expectedResult = {
  channelChangeCountChart: {
    time: [
      '2022-04-07T09:15:00.000Z',
      '2022-04-08T09:30:00.000Z'
    ],
    channelChangeCount: [1, 1]
  },
  relatedIncidents: [
    fakeIncident({
      id: 'df5339ba-da3b-4110-a291-7f8993a274f3',
      severity: 0.5,
      code: fakeIncidentChannelDist.code,
