...
import { mocked, mockedKPIs, mockedStatusTrail }              from './__tests__/mockedCDfschannelsDisable'
import { configuration, kpis, IntentAIDetails, IntentAIForm } from './CDfschannelsDisable'
