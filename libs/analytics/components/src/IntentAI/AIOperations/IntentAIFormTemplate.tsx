...
export const IntentAIFormTemplate = (
  messages: {
    ...
    apply: React.ReactElement<typeof FormattedMessage>;
    doNotApply: React.ReactElement<typeof FormattedMessage>;
  }
) => {
  const { apply, doNotApply } = messages
  ...
  return createIntentAIForm<{ enable: boolean }>({
