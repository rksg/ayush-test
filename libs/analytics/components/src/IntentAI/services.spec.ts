...
> EDU-MeshZone_S12348 (Venue)`
      ...
      const expectedResult = [
        ...
        },
        {
          ...
          statusTooltip: 'The change recommendation has been scheduled for 06/17/2023 00:00, via the user action "Optimize" initiated by the user fakeUserWithOptimize lastName5566.'
        },
        {
          ...
          status: Statuses.scheduled,
          statusLabel: 'Scheduled',
          statusTooltip: 'The change recommendation has been scheduled for 06/17/2023 00:00, via the user action "1-Click Optimize" initiated by the user fakeUserWithOneClickOptimize lastName5566.'
        },
        {
 ...
 The intent is currently paused. To process new data and generate updated recommendations using ML algorithms, please select the "Resume" action.`
        },
        {
          ...
          statusTooltip: 'The Revert of the IntentAI recommended changes are scheduled for 06/17/2023 00:00, via user action "Revert" initiated by the user fakeUserWithRevert lastName5566.'
        },
        {
 ...
 The intent is currently paused. To process new data and generate updated recommendations using ML algorithms, please select the "Resume" action.`
        ...
        },
        {
          ...
          status: Statuses.paused,
          statusLabel: 'Paused',
          statusTooltip: 'The Intent is paused by the user action "Pause" initiated by the user fakeUser lastName5566. A Paused Intent will refrain from executing any tasks, including KPI measurement, ML model generations, recommendation generation and configuration changes.'
        },
        {
