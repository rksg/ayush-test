...
export const wlanGroupKeyMap = [
  ...
  { id: 11, value: 'initialState.CcmWlanGroup.override_nas_id', text: 'TBD', textAlto: 'TBD', enumType: '', incidents: {}, kpis: {} },
  { id: 12, value: 'initialState.CcmWlanGroup.override_vlan_id', text: 'TBD', textAlto: 'TBD', enumType: '', incidents: {}, kpis: {} },
  { id: 13, value: 'initialState.CcmWlanGroup.override_vlan_pooling_id', text: 'TBD', textAlto: 'TBD', enumType: '', incidents: {}, kpis: {} },
  { id: 14, value: 'initialState.CcmWlanGroup.wlan_id', text: 'TBD', textAlto: 'TBD', enumType: '', incidents: {}, kpis: {} },
  { id: 15, value: 'initialState.CcmWlanGroup.key', text: 'TBD', textAlto: 'TBD', enumType: '', incidents: {}, kpis: {} },
  { id: 16, value: 'initialState.CcmWlanGroup.value', text: 'TBD', textAlto: 'TBD', enumType: '', incidents: {}, kpis: {} }
]
