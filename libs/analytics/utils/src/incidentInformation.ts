...
export interface incidentInformationType {
  category: { defaultMessage: string }
  subCategory: { defaultMessage: string }
  shortDescription: { defaultMessage: string }
  longDescription: { defaultMessage: string }
  incidentType: 'network' | 'switch' | 'common'
}


export const incidentInformation: Record<string, incidentInformationType> = {
  'ttc': {
