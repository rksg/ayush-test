...
const firmwareVersionText = '{br}{br}Data is displayed for switches with firmware version 10.0.10h{mlisaVersionSuffix}.'
...
export const kpiConfig = {
  ...
  association: {
    ...
    pill: {
      ...
      thresholdFormatter: null,
      pillSuffix: pillSuffix.success,
      tooltip: defineMessage({ defaultMessage: 'The time-series graph on the left displays the percentage of association attempts that have completed successfully. An association attempt is deemed successful when the Wifi client receives an Association ID from the AP. It is normal for a single Wifi client to have more than one association attempts.{br}{br}The bar chart on the right captures the daily percentage over the last 7 days of the selected time range.' })
    },
    configChange: {
  ...
  userAuthentication: {
    ...
    pill: {
      ...
      thresholdFormatter: null,
      pillSuffix: pillSuffix.success,
      tooltip: defineMessage({ defaultMessage: 'The time-series graph on the left displays the percentage of 802.11 authentication attempts that has completed successfully. 802.11 authentication is the first step in establishing a Wi-Fi connection, and it requires a Wi-Fi client to establish its identity as a valid 802.11 device with an AP. No data encryption or security is available at this stage, and it is not to be confused with WPA or 802.1X authentication.{br}{br}The bar chart on the right captures the daily percentage over the past 7 days.' })
    },
    configChange: {
  ...
  dhcp: {
    ...
    pill: {
      ...
      thresholdFormatter: null,
      pillSuffix: pillSuffix.success,
      tooltip: defineMessage({ defaultMessage: 'The time-series graph on the left displays the percentage of DHCP connection attempts that have completed successfully. A DHCP connection attempt is deemed successful when the Wifi client has received an IP address from the DHCP server. Do note that a single Wifi client could have multiple DHCP connection attempts.{br}{br}The bar chart on the right captures the daily percentage over the last 7 days of the selected time range.' })
    },
    configChange: {
  ...
  radius: {
    ...
    pill: {
      ...
      thresholdFormatter: null,
      pillSuffix: pillSuffix.success,
      tooltip: defineMessage({ defaultMessage: 'The time-series graph on the left displays the percentage of RADIUS authentication attempts that have completed successfully. A RADIUS authentication attempt is deemed successful when all the necessary handshakes in the RADIUS protocol are completed, and the client is either allowed or denied access. Do note that a single Wifi client could have multiple authentication attempts.{br}{br}The bar chart on the right captures the daily percentage over the last 7 days of the selected time range.' })
    },
    configChange: {
  ...
  roamingSuccess: {
    ...
    pill: {
      ...
      thresholdFormatter: null,
      pillSuffix: pillSuffix.success,
      tooltip: defineMessage({ defaultMessage: 'This metric measures the percentage of roaming attempts that have completed successfully. A roaming attempt is deemed successful when the Wifi client has its session transferred from one AP to the next. It is possible for a single Wifi client to have multiple roaming attempts.{br}{br}The bar chart on the right captures the daily percentage over the last 7 days of the selected time range.' })
    },
    configChange: {
  ...
  rss: {
    ...
    pill: {
      ...
      thresholdFormatter: null,
      pillSuffix: pillSuffix.meetGoal,
      tooltip: defineMessage({ defaultMessage: 'The time-series graph on the left displays the percentage of client sessions with average RSS that has met the configured SLA. The bar chart on the right captures the distribution of the RSS.' })
    },
    configChange: {
      apiMetric: 'clientRss',
  ...
  apServiceUptime: {
    ...
    pill: {
      ...
      pillSuffix: pillSuffix.meetGoal,
      tooltip: defineMessage({ defaultMessage: 'AP-{smartZone} connection uptime measures the percentage of time the AP radios are fully available for client service.\n\nThe time-series graph on the left displays the percentage of AP-{smartZone} connection uptime samples across time that meets the configured SLA. The bar chart on the right displays the distribution of AP service uptime across the number of APs.' })
  ...
  apToSZLatency: {
    ...
    pill: {
      ...
      thresholdFormatter: null,
      pillSuffix: pillSuffix.meetGoal,
      tooltip: defineMessage({ defaultMessage: 'The time-series graph on the left displays the percentage of APs that have AP-to-{smartZone} control plane latency which meets the configured SLA. The bar chart on the right captures the distribution of the latency across the number of APs.' })
    },
    configChange: {
      apiMetric: 'apSzLatency',
      format: formatter('durationFormat'),
  ...
  clusterLatency: {
    ...
    pill: {
      ...
      tooltip: defineMessage({
        defaultMessage:
          'The time-series graph on the left displays the percentage of samples that have intra-SZ cluster latency (which is the latency between each node within a SZ cluster) which meets the configured SLA. The bar chart on the right captures the distribution of the latency across the number of clusters.'
      })
    },
    configChange: {
      apiMetric: 'szLatency',
  ...
  onlineAPs: {
    ...
    pill: {
      ...
      pillSuffix: '',
      thresholdFormatter: null,
      tooltip: defineMessage({ defaultMessage: 'Online APs measures the percentage of APs which are online and connected to {smartZone}.{br}{br}The time-series graph on the left displays the Online AP percentage across time. The bar chart on the right captures the daily Online AP percentage over the last 7 days of the selected time range.' })
    },
    configChange: {
  ...
  switchIpv4MulticastUtilization: {
    ...
    pill: {
      ...
      thresholdFormatter: numberWithPercentSymbol,
      tooltip: defineMessage({
        defaultMessage: 'Compliance metric of switches where IPv4 multicast route entries are within the threshold of the configured/supported capacity.' + firmwareVersionText
      })
    }
  },
  switchIpv6MulticastUtilization: {
    ...
    pill: {
      ...
      thresholdFormatter: numberWithPercentSymbol,
      tooltip: defineMessage({
        defaultMessage: 'Compliance metric of switches where IPv6 multicast route entries are within the threshold of the configured/supported capacity.' + firmwareVersionText
      })
    }
  },
  switchIpv4UnicastUtilization: {
    ...
    pill: {
      ...
      thresholdFormatter: numberWithPercentSymbol,
      tooltip: defineMessage({
        defaultMessage: 'Compliance metric of switches where IPv4 unicast route entries are within the threshold of the configured/supported capacity.' + firmwareVersionText
      })
    }
  },
  switchIpv6UnicastUtilization: {
    ...
    pill: {
      ...
      thresholdFormatter: numberWithPercentSymbol,
      tooltip: defineMessage({
        defaultMessage: 'Compliance metric of switches where IPv6 unicast route entries are within the threshold of the configured/supported capacity.' + firmwareVersionText
      })
    }
  },
  switchArpUtilization: {
    ...
    pill: {
      ...
      thresholdFormatter: numberWithPercentSymbol,
      tooltip: defineMessage({
        defaultMessage: 'Compliance metric of switches where ARP table entries are within the threshold of the configured/supported capacity.' + firmwareVersionText
      })
    }
  },
  switchMacUtilization: {
    ...
    pill: {
      ...
      thresholdFormatter: numberWithPercentSymbol,
      tooltip: defineMessage({
        defaultMessage: 'Compliance metric of switches where Mac table entries are within the threshold of the configured/supported capacity.' + firmwareVersionText
      })
    }
  },
