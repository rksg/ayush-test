...
export const triBandApCap = {
  apModels: [
    ...
    { model: 'R670',
      allowCbandCountry: ['GB', 'DE', 'AT', 'BE', 'BG', 'HR', 'CY', 'CZ', 'DK', 'EE', 'FI', 'FR', 'GR', 'HU', 'IT', 'LV', 'LU', 'MT', 'NL', 'NO', 'PL', 'PT', 'RO', 'SK', 'SI', 'ES', 'SE', 'LT', 'IE', 'ME', 'CH'],
      allowDfsCountry: ['US', 'SG'],
      canSupportCellular: false,
      canSupportLacp: false,
      canSupportPoeMode: true,
      ...
      isOutdoor: false,
      lanPortPictureDownloadUrl:
        'https://fakeLanPortPic/wifi/firmware/7.1.1.520.533/r670.jpg',
      lanPorts: [
        {
          id: '1',
          defaultTyp: 'TRUNK',
      ...
      lldpMgmtEnable: true,
      maxChannelization5G: 160,
      maxChannelization6G: 320,
      maxChannelization24G: 40,
      pictureDownloadUrl:
        'https://fakeApPic/wifi/firmware/7.1.1.520.533/r760.jpg',
      poeModeCapabilities: ['Auto', '802.3at', '802.3bt-Class_5'],
      requireOneEnabledTrunkPort: true,
      support11AX: true,
      support11BE: true,
      ...
      supportTriRadio: true,
      supportMesh: true,
      supportBandCombination: true,
      defaultBandCombination: 'DUAL',
      bandCombinationCapabilities: [ 'DUAL', 'TRIPLE' ],
      ...
      supportSoftGre: true,
      supportIoT: true,
      version: '7.1.1.520.533'
    },
    { model: 'T670',
      allowCbandCountry: ['RL', 'EG', 'GB', 'DE', 'AT', 'BE', 'BG', 'HR', 'CY', 'CZ', 'DK', 'EE', 'FI', 'FR', 'GR', 'HU', 'IT', 'LV', 'LU', 'MT', 'NL', 'NO', 'PL', 'PT', 'RO', 'SK', 'SI', 'ES', 'SE', 'LT', 'IE', 'ME', 'CH'],
      allowDfsCountry: ['US', 'SG'],
      canSupportCellular: false,
      canSupportLacp: false,
      canSupportPoeMode: true,
      ...
      isOutdoor: true,
      lanPortPictureDownloadUrl:
        'https://fakeLanPortPic/wifi/firmware/7.1.1.520.533/t670.jpg',
      lanPorts: [
        {
          id: '1',
          defaultTyp: 'TRUNK',
      ...
      maxChannelization24G: 40,
      pictureDownloadUrl:
        'https://fakeApPic/wifi/firmware/7.1.1.520.533/t760.jpg',
      poeModeCapabilities: ['Auto', '802.3at', '802.3bt-Class_5'],
      requireOneEnabledTrunkPort: true,
      support11AX: true,
      support11BE: true,
