...
./tools/docker/locales/generate.sh <target_app, main, ra ...> # extract and compile JSONs
./tools/docker/locales/genCount.sh <target_app, main, ra ...> # get Unique Strings, Word Count and Unique Word Count
```
